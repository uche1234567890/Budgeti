  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit((data) => submitForm(data))}>
            ...
            {...register("firstname", {required: "Firstname is required.", maxLength: { value: 20, message: "Firstname should have a max length of 20 character"}})}/>
            {errors.firstname && (<p className="text-red-500 text-sm pb-2 font-bold">{errors.first.message}</p>)}

            <input type="text" name="lastname" id="lastname" placeholder="Lastname" className="border p-3 rounded-lg" 
            {...register("lastname", {required: "Lastname is required.", maxLength: { value: 20, message: "Lastname should have a max length of 20 character"}})}/>
